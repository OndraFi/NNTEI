...
public class Jazyk {
    ...
    public static boolean jeIdentifikator(String retezec){
    ...
    public static boolean jeCisloBezZnamenka(String retezec){
    ...
    public static boolean jeCeleCislo(String retezec){
